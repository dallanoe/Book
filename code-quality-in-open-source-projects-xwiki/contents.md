...
Les différentes métriques évoquées dans cette synthèse ont été intégrées dans le questionnaire.
...
Ces quatre personnes détiennent ~80% de parenté sur le code. Ils continuent de contribuer et d'aider à l'intégration des nouvelles fonctionnalités. Ils s'assurent aussi de l'entretien du backlog et de la gestion des tickets sur le Jira. (Voir : https://logging.apache.org/log4j/2.0/jira-report.html). 
...
Les utilisateurs implémentent leur besoin et le font partager à la communauté.
